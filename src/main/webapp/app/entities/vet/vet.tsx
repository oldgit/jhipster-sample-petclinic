...
import { getEntities, reset } from './vet.reducer';
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('firstName')}>
                    <Translate contentKey="petclinicApp.vet.firstName">First Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('lastName')}>
                    <Translate contentKey="petclinicApp.vet.lastName">Last Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
...
const mapStateToProps = ({ vet }: IRootState) => ({
  ...
  loading: vet.loading,
  totalItems: vet.totalItems,
  links: vet.links,
  entity: vet.entity,
  updateSuccess: vet.updateSuccess
});
