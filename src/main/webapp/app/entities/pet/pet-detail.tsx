...
export const PetDetail = (props: IPetDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="petclinicApp.pet.detail.title">Pet</Translate> [<b>{petEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>
            <TextFormat value={petEntity.birthDate} type="date" format={APP_LOCAL_DATE_FORMAT} />
          </dd>
          <dt>
            <span id="type">
